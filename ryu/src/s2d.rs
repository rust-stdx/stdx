use crate::{
    ...
    d2s,
    d2s_intrinsics::{mul_shift_64, multiple_of_power_of_2, multiple_of_power_of_5},
    parse::Error,
};
...
pub fn s2d(buffer: &[u8]) -> Result<f64, Error> {
    ...
    if e10 >= 0 {
        ...
        m2 = mul_shift_64(m10, unsafe { d2s::DOUBLE_POW5_SPLIT.get_unchecked(e10 as usize) }, j as u32);
